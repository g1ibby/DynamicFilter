 ...
 */
class Oggetto_Pay_Model_Pay extends Mage_Payment_Model_Method_Abstract
{
    /**
     * @var string Code method payment
     */
    protected $_code = 'pay';
    ...
    /**
     * Returned url for payment
     *
     * @return string
     */
    public function getOrderPlaceRedirectUrl()
    {
        return Mage::getUrl('pay/index/send', array('_secure' => true));
    }
